...
\begin{table}[h]
    ...
    \begin{tabular}{|l|l|c|}
        ...
        \hline
        -minCount & Nombre minimal d'occurrences d'un mot & 1000 \\
        -minCountLabel & Nombre minimal d'occurrences d'un label & 0 \\
        -wordNgrams & Longueur maximale des n-grammes de mots & 1 \\
        -bucket & Nombre de buckets & 10e6 \\
        -minn & Longueur minimale des n-grammes de caractères & 1 \\
        -maxn & Longueur maximale des n-grammes de caractères & 5 \\
        -loss & Fonction de perte & softmax \\
        -dim & Taille des vecteurs de mots & 256 \\
        -epoch & Nombre d'époques & 9 \\
        -lr & Taux d'apprentissage & 1.5 \\
        \hline
    \end{tabular}
    \caption{Hyperparamètres d'entraînement de notre modèle FastText}
