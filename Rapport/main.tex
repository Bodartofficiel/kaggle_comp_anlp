...
\runninghead{NLP project report} % A shortened article title to appear in the running head, leave this command empty for no running head
...
\title{ANLP Kaggle project\\ \LARGE Language identification} % Article title with subtitle
